...
">
    <div class="container text-white" style="max-width: 700px;">
      <h1 class="mb-3" style="font-weight: 600; font-size: 2.8rem; letter-spacing: 1px;">Annual Reports</h1>
      <p class="lead" style="line-height: 1.8; color: #e8e8e8; font-size: 1.1rem;">
        Annual reports provide a comprehensive overview of the school’s activities, achievements, and financial performance throughout the year.
      </p>
    </div>
  </section>
        ...
        <div class="col-lg-10">
          <div class="p-5 rounded shadow-sm" style="background: #ffffff; border-left: 6px solid #24c1dd;">
            ...
            <p style="line-height:1.8; color:#555;">
              <strong>Reminder:</strong> Reports will be uploaded after finalization.
            </p>
          </div>
        </div>
      </div>
