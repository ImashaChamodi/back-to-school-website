...
<body data-bs-spy="scroll" data-bs-target=".navbar-nav">
  ...
  <section class="hero"
    ...
    background: linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)), 
                url('images/About_image.jpg') no-repeat center center fixed; 
    ...
    align-items: center;
    min-height: 60vh;   /* reduce height */
">
    <div class="container text-center text-white"
      style="max-width: 50%; background: rgba(0,0,0,0.4); padding: 30px; border-radius: 10px;">
      <h1 class="mb-3" style="font-weight: 500; font-size: 2.5rem;">The Board</h1>
      <p class="lead" style="line-height: 1.7; color: #f1f1f1; font-size: 1.1rem;">
