...
<section class="hero" style="background: linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)), url('images/About_image.jpg') no-repeat center center fixed; background-size: cover; padding-top: 120px; padding-bottom: 80px;">
  <div class="container text-center text-white" style="max-width: 900px;">
      <h1 class="mb-3" style="font-weight: 500;">Audit Reports</h1>
    ...
    <div class="row justify-content-center">
      <div class="col-lg-10">
        <div class="p-5 rounded shadow-sm" style="background: #ffffff; border-left: 6px solid #24c1dd;">
            ...
            ⚠️ Note: The current section is still under preparation. The financial year is not yet completed, and the processes are ongoing. We expect to finalize everything by March 31, 2026. After that, the relevant documents and reports will be uploaded. Thank you for your patience as we complete the necessary procedures.
            </p>
            <p style="line-height:1.8; color:#555;">
                <strong>Note:</strong> Reports will be uploaded after audit completion.
            </p>
        </div>
      </div>
    </div>
